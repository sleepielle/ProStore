...
export const insertCartSchema = z.object({
  ...
  //users can add to cart even if they are not logged in. they are required to login if they want to buy.
...
// make sure it includes one of the methods used in the constant
